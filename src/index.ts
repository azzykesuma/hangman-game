...
const wordsWrapper = document.querySelector('.alphabetWrapper') as HTMLElement
const categoryWrap = document.querySelector('.category');
const answerDisplay = document.getElementById('hold') as HTMLElement
const clue = document.getElementById('clue') as HTMLElement;
const buttonHint = document.getElementById('hint') as HTMLButtonElement
...
function generateAnswerDisplay(word:string) {
